 ...
 * 277405   8/8/2021    Hemant Singh        Bugfix 277405: Changed 'String Collection' from 'String' in BCC availableRecipients. This fix is needed to send email to BCC address
**/
...
export default class SendBetterEmailCPE extends LightningElement {
	...
	@track availableRecipients = [{
		...
		typeMap: {
			...
			'String Collection': 'SendBCCthisStringCollectionOfEmailAddresses', //Bugfix-277405 Changed 'String Collection' from 'String'
